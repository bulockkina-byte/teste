...
<style>
  ...
  <table style="border:1px solid #000; border-collapse:separate; border-spacing:0; margin-top:3px;">
    ...
    ${e('tpTexto') ? `<tr><td style="border:none; padding:2px 8px; font-size:11px;">${e('tpTexto')}</td></tr>` : ''}
  </table>
  ...
  <table style="border:1px solid #000; border-collapse:separate; border-spacing:0; margin-top:3px;">
    ...
    ${e('extTexto') ? `<tr><td style="border:none; padding:2px 8px; font-size:11px;">${e('extTexto')}</td></tr>` : ''}
  </table>
  ...
  <table style="border:1px solid #000; border-collapse:separate; border-spacing:0; margin-top:3px;">
    ...
    ${e('equipTexto') ? `<tr><td style="border:none; padding:2px 8px; font-size:11px;">${e('equipTexto')}</td></tr>` : ''}
  </table>
  ...
  <table style="border:1px solid #000; border-collapse:separate; border-spacing:0; margin-top:3px;">
    ...
    ${e('edifTexto') ? `<tr><td style="border:none; padding:2px 8px; font-size:11px;">${e('edifTexto')}</td></tr>` : ''}
  </table>
